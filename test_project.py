...
class ProjectTest(unittest.TestCase):
    ...
    @patch(
        ...
        side_effect=[
            ...
            "T1",
            "Member",
            "vopmembershiptest+jdoe@gmail.com",
            "1234567890",
            "123 Street",
            "City",
            "CA",
...
VOP Membership team"""
    ...
    def test_all_active_email(self, mock_query, mock_generate, mock_send):
        ...
        mock_query.return_value = [
            "vopmembershiptest+test1@gmail.com",
        ...
        mock_generate.side_effect = lambda tmpl, email, fl: (
            "Test Subject",
            f"Test Body for {email}",
        )
    ...
    def test_main(self, mock_input, mock_stdout):
        ...
        bad_sheet_file = (
            "data-files/unittest_badsheet.xlsx"  # No Inactive Members Sheet
        )
